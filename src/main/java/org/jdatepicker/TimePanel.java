...
public interface TimePanel extends TimeComponent {
     ...
     */
    void setEnableMinutes(boolean enableMinutes);
     ...
     */
    void setEnableSeconds(boolean enableSeconds);
     ...
     */
    void setEnableNanoseconds(boolean enableNanoSeconds);
     ...
     */
    void setAlwaysShowSpinner(boolean alwaysShowSpinner);
